...
import ua.shvets.unit.db.EmployeeTable.default
...
object CabinetTable : IntIdTable("Cabinet") {
    ...
    val lastUpdateTime = timestamp("last_update_time").default(Instant.fromEpochMilliseconds(System.currentTimeMillis()))
}
